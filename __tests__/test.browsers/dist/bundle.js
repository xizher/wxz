...
/* harmony import */ var _src_data_structure_linked_list_linked_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../src/data-structure/linked-list/linked-list */ "./src/data-structure/linked-list/linked-list.js");
/* harmony import */ var _src_data_structure_linked_list_linked_list_node__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../src/data-structure/linked-list/linked-list-node */ "./src/data-structure/linked-list/linked-list-node.js");
/* harmony import */ var _src_js_utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../src/js-utils */ "./src/js-utils/index.js");
...
window.onload = function () {
  {
    log(_src_js_utils__WEBPACK_IMPORTED_MODULE_3__.BaseUtils.getRootPath());
  }
  ...
  {
    log(_src_js_utils__WEBPACK_IMPORTED_MODULE_3__.BaseUtils.isFromMobileBrowser());
  }
  ...
  }
  {
    ...
    // console.log(vlist)
    var node = (0,vue__WEBPACK_IMPORTED_MODULE_0__.reactive)(new _src_data_structure_linked_list_linked_list_node__WEBPACK_IMPORTED_MODULE_2__.default(1)); // const node = new LinkedListNode(1)

    (0,vue__WEBPACK_IMPORTED_MODULE_0__.watch)(node, function (val) {
      console.log(val.value);
    }, {
      deep: true
    });
    node.value = 2;
    console.log(node.value); // const test = reactive({
    //   a: 1
    // })
...
/***/ "./src/data-structure/linked-list/linked-list-node.js":
/*!************************************************************!*\
  !*** ./src/data-structure/linked-list/linked-list-node.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _listener_listener__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../listener/listener */ "./src/listener/listener.js");
...
var LinkedListNode = function () {
  //#region 私有变量
  var _value = new WeakMap(); //#endregion
  //#region 类体


  var __LinkedListNode__ = /*#__PURE__*/function (_Listener) {
    _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_2___default()(__LinkedListNode__, _Listener);

    var _super = _createSuper(__LinkedListNode__);

    _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(__LinkedListNode__, [{
      key: "value",
      //#region gettrt
      get: function get() {
    ...
    function __LinkedListNode__(value) {
      var _this;

      var next = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var previous = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;

      _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, __LinkedListNode__);
  ...
  }(_listener_listener__WEBPACK_IMPORTED_MODULE_5__.Listener); //#endregion
...
/***/ "./src/data-structure/linked-list/linked-list.js":
/*!*******************************************************!*\
  !*** ./src/data-structure/linked-list/linked-list.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _linked_list_node__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./linked-list-node */ "./src/data-structure/linked-list/linked-list-node.js");
/* harmony import */ var _listener_listener__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../listener/listener */ "./src/listener/listener.js");
...
var LinkedList = function () {
  ...
  var _length = new WeakMap(); //#endregion
  //#region 类体


  var __LinkedList__ = /*#__PURE__*/function (_Listener) {
    _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_3___default()(__LinkedList__, _Listener);

    var _super = _createSuper(__LinkedList__);

    _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(__LinkedList__, [{
      key: "length",
      //#region getter
      get: function get() {
    ...
    function __LinkedList__() {
      var _this;

      _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, __LinkedList__);

      _this = _super.call(this);

      _head.set(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_1___default()(_this), new _linked_list_node__WEBPACK_IMPORTED_MODULE_6__.default(null));

      _length.set(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_1___default()(_this), 0);
    ...
    _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(__LinkedList__, [{
      ...
      value: function getAt(index) {
        ...
        var current = _head.get(this).next;
      ...
      value: function append(value) {
        var node = new _linked_list_node__WEBPACK_IMPORTED_MODULE_6__.default(value);

        var head = _head.get(this);
        ...
        if (head.next === null) {
          ...
          var current = this.getAt(length - 1);
          current.next = node;
        }
      ...
      key: "removeAll",
      value: function removeAll(value) {
        var previous = _head.get(this);
        ...
        if (removedCount > 0) {
          this.fire('removed', {
            removeValue: value,
            removeIndex: removedCount > 1 ? null : removeIndex,
            totalLength: this.length,
            removeAll: removedCount > 1
          });
          this.fire('node-changed', {
            changeIndex: this.length,
            type: 'remove',
            value: value,
            changeMany: removedCount > 1
          });
        }
  ...
  }(_listener_listener__WEBPACK_IMPORTED_MODULE_7__.Listener); //#endregion
...
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/helpers/defineProperty */ "./node_modules/@babel/runtime/helpers/defineProperty.js");
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../$libs/crypto-js/crypto-js */ "./src/$libs/crypto-js/crypto-js");
/* harmony import */ var _$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3__);
...
var CryptoUtils = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(CryptoUtils, null, [{
    ...
    value: function enCrypto(str) {
      ...
      var key = _$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().enc.Utf8.parse(STRING_CRYPTO_KEY);
      var iv = _$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().enc.Utf8.parse(STRING_CRYPTO_IV);
      var encrypted = '';
      var newVal = _$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().enc.Utf8.parse(str);
      encrypted = _$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().AES.encrypt(newVal, key, {
        iv: iv,
        mode: (_$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().mode.CBC),
        padding: (_$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().pad.Pkcs7)
      });
    ...
    value: function deCrypto(str) {
      ...
      var key = _$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().enc.Utf8.parse(STRING_CRYPTO_KEY);
      var iv = _$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().enc.Utf8.parse(STRING_CRYPTO_IV);
      var encryptedHexStr = _$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().enc.Hex.parse(str);
      var newVal = _$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().enc.Base64.stringify(encryptedHexStr);
      var decrypt = _$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().AES.decrypt(newVal, key, {
        iv: iv,
        mode: (_$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().mode.CBC),
        padding: (_$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().pad.Pkcs7)
      });
      var decryptedStr = decrypt.toString((_$libs_crypto_js_crypto_js__WEBPACK_IMPORTED_MODULE_3___default().enc.Utf8));
...
var Listener = function () {
   ...
   */
  var _eventPool = new WeakMap(); //#endregion
  ///#region 类体


  var __Listener__ = /*#__PURE__*/function () {
    //#region 构造函数
    function __Listener__() {
      _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, __Listener__);
    ...
    _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(__Listener__, [{
      key: "on",
      value: function on(name, fn, scope) {
        ...
        var eventPool = _eventPool.get(this);
      ...
      value: function fire(name, data) {
        ...
        var eventArr = _eventPool.get(this)[name];
        ...
        if (eventArr) {
          ...
          for (var i = 0; i < eventArr.length; i++) {
            var item = eventArr[i];
            var fn = item[0]; // event.scope = item[1] ?? {}
